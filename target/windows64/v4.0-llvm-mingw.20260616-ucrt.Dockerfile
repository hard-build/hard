...
LABEL org.opencontainers.image.source="https://github.com/hard-build/hard" \
      ...
      org.opencontainers.image.version="v4.0-llvm-mingw.20260616-ucrt" \
...
ENV HOME=/tmp
ENV HARD_ROOT=/hard
ENV HARD_ENV=windows64:v4.0-llvm-mingw.20260616-ucrt
...
ENV WINEARCH=win64
ENV WINEDEBUG=-all
ENV WINEPREFIX=/hard/env/windows64:v4.0-llvm-mingw.20260616-ucrt/wine
